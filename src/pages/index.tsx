...
export default function Home() {
	...
	const { write: setupWrite } = useSetup(
		hash(factor),
		...
		>
			...
			{!isScanningComplete && address && qruri && (
				<div className="flex flex-col items-center gap-10">
					<p>
						Enable 2FA for this deposit contract scan this qr code
						with your choice of authenticator app.
					</p>
					<QRCode value={qruri} />
					<button
			...
			<div>
				{!isverified && isScanningComplete && (
					<div className="flex flex-col items-center gap-10">
						<p>
							Enter the code displaying on your authenticator
							app.(Ex. 467 890)
						</p>
						<input
							value={payload}
					...
					<div className="flex flex-col items-center gap-16 p-10 rounded-lg shadow-md border-2 border-blue-100 shadow-blue-100">
						...
						<div className="space-y-5">
							...
							<Input
								...
								disabled={
									isAccountLocked || withdrawAmountButton
								}
								title="withdraw"
								placeholder="1"
								token={withdrawToken}
